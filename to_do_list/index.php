...
<head>
    ...
    <link href="delete.php" rel="stylesheet">
    <link href="add.php" rel="stylesheet">
</head>
<body>
    <div class="container">
        <h1>Ma To-Do List !</h1>
        ...
        <form action="index.php" method="post">
            <button type="submit" name="delete">Supprimer</button><br><br> <!-- Bouton pour supprimer les tâches sélectionnées -->
            <?php 
    ...
    if(isset($_POST['delete'])) { // Vérifie si le formulaire de suppression est soumis
        if(isset($_POST['task'])) { // Vérifie si des tâches sont sélectionnées pour suppression
            ...
            echo "Veuillez sélectionner au moins une tâche à supprimer."; // Message si aucune tâche n'est sélectionnée pour suppression
        }
    }
?>
